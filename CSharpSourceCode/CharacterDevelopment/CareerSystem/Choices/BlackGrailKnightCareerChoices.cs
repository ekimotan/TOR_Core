...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class BlackGrailKnightCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializeKeyStones()
        {
            ...
            _curseOfMousillonKeystone.Initialize(CareerID, "{=curse_of_mousillon_keystone_str}10% extra physical damage during Knightly Charge. The ability scales with the One Handed skill.", "CurseOfMousillon", false,
            ...
            _unbreakableArmyKeystone.Initialize(CareerID, "{=unbreakable_army_keystone_str}Knightly Charge grants 20% physical resistance. Mount will not rear during the ability.", "UnbreakableArmy", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
        ...
        {
            _curseOfMousillonPassive1.Initialize(CareerID, "{=curse_of_mousillon_passive1_str}Increases Hitpoints by 40.", "CurseOfMousillon", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.Health));
            _curseOfMousillonPassive2.Initialize(CareerID, "{=curse_of_mousillon_passive2_str}All Knight troops receive 30 bonus points in their Polearm skill.", "CurseOfMousillon", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(30, nameof(DefaultSkills.Polearm),
                (characterObject) => characterObject.IsKnightUnit()));
            _curseOfMousillonPassive3.Initialize(CareerID, "{=curse_of_mousillon_passive3_str}Mousillon ranged troops gain 15% extra ranged damage.", "CurseOfMousillon", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopDamage, new DamageProportionTuple(DamageType.Physical, 15), AttackTypeMask.All,
            ...
            _curseOfMousillonPassive4.Initialize(CareerID, "{=curse_of_mousillon_passive4_str}Ill fated Knight Companions occasionally train Bretonnian Peasants to Mousillon Peasants.", "CurseOfMousillon", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special)); //

            _swampRiderPassive1.Initialize(CareerID, "{=swamp_rider_passive1_str}50% additional Hitpoints for the player's mount.", "SwampRider", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(50, PassiveEffectType.HorseHealth, true)); //
            ...
            _unbreakableArmyPassive2.Initialize(CareerID, "{=unbreable_army_passive2_str}40% chance to recruit an extra unit of the same type free of charge.", "UnbreakableArmy", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.Special, true));
            _unbreakableArmyPassive3.Initialize(CareerID, "{=unbreable_army_passive3_str}Gain 15% physical resistance to melee and ranged attacks.", "UnbreakableArmy", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.Physical, 15), AttackTypeMask.Ranged | AttackTypeMask.Melee));
            _unbreakableArmyPassive4.Initialize(CareerID, "{=unbreable_army_passive4_str}Increases Party size by 50.", "UnbreakableArmy", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(50, PassiveEffectType.PartySize));

            _scourgeOfBretonniaPassive1.Initialize(CareerID, "{=scourge_of_bretonnia_passive1_str}Increases Hitpoints by 40.", "ScourgeOfBretonnia", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.Health));
            _scourgeOfBretonniaPassive2.Initialize(CareerID, "{=scourge_of_bretonnia_passive2_str}Gain 25 Dark Energy daily.", "ScourgeOfBretonnia", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.CustomResourceGain));
            _scourgeOfBretonniaPassive3.Initialize(CareerID, "{=scourge_of_bretonnia_passive3_str}Mousillon Knight damage against infantry  is increased by 15%.", "ScourgeOfBretonnia", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopResistance, new DamageProportionTuple(DamageType.All, 15), AttackTypeMask.Spell,
            ...
            _scourgeOfBretonniaPassive4.Initialize(CareerID, "{=scourge_of_bretonnia_passive4_str}Any Bret. Knight units can be transformed to ill-fated mousillon units.", "ScourgeOfBretonnia", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special, true));

            _robberKnightPassive1.Initialize(CareerID, "{=robber_knight_passive1_str}Horse charge damage is increased by 50%.", "RobberKnight", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(40, PassiveEffectType.HorseChargeDamage, true));
            ...
            _lieOfLadyPassive1.Initialize(CareerID, "{=lie_of_lady_passive1_str}15% extra melee magic damage.", "LieOfLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Magical, 15), AttackTypeMask.Melee));
            _lieOfLadyPassive2.Initialize(CareerID, "{=lie_of_lady_passive2_str}Necromancer companions gain 25 Winds of magic.", "LieOfLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special, false));
            _lieOfLadyPassive3.Initialize(CareerID, "{=lie_of_lady_passive3_str}Dark Energy upkeep for Knights of the black grail is reduced by 25%.", "LieOfLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-25, PassiveEffectType.CustomResourceUpkeepModifier, true,
                characterObject => characterObject.StringId.Contains("tor_m_knight_of_the_black_grail")));
            _lieOfLadyPassive4.Initialize(CareerID, "{=lie_of_lady_passive4_str}Knights of the black grail deal 15% magical damage.", "LieOfLady", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopDamage, new DamageProportionTuple(DamageType.Magical, 15), AttackTypeMask.Melee,
                (attacker, victim, mask) => attacker.BelongsToMainParty() && attacker.Character.StringId == "tor_m_knight_of_the_black_grail"));

            _blackGrailVowPassive1.Initialize(CareerID, "{=black_grail_vow_passive1_str}Companion limit of party is increased by 10.", "BlackGrailVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.CompanionLimit));
            _blackGrailVowPassive2.Initialize(CareerID, "{=black_grail_vow_passive2_str}Hits below 15 damage will not stagger the player.", "BlackGrailVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(15, PassiveEffectType.Special));
            _blackGrailVowPassive3.Initialize(CareerID, "{=black_grail_vow_passive3_str}Mousillon Knights gain 15% Wardsave.", "BlackGrailVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.TroopResistance, new DamageProportionTuple(DamageType.All, 15), AttackTypeMask.All,
                (attacker, victim, mask) => victim.BelongsToMainParty() && isMousillonKnight(victim.Character as CharacterObject)));
            _blackGrailVowPassive4.Initialize(CareerID, "{=black_grail_vow_passive4_str}Every necromancer and Vampire companion gains 10 dark energy per day.", "BlackGrailVow", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(10, PassiveEffectType.CompanionLimit));
        }
