...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class GrailKnightCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _monsterSlayerPassive4.Initialize(CareerID, "{=monster_slayer_passive4_str}Hits below 15 damage will not stagger the player.", "MonsterSlayer", false, ChoiceType.Passive, null); // Agent extension 83,
