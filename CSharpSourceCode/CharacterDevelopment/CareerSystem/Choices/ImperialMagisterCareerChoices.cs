...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class ImperialMagisterCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializeKeyStones()
        {
            ...
            _studyAndPractiseKeystone.Initialize(CareerID, "{=study_and_practise_keystone_str}Ability scaling adds  0.25% physical resistance per point.", "StudyAndPractise", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
            ...
            _teclisTeachingsKeystone.Initialize(CareerID, "{=teclis_teachings_keystone_str}You charge 25% longer. Ability scales with Steward.", "TeclisTeachings", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
            ...
            _imperialEnchantmentKeystone.Initialize(CareerID, "{=imperial_enchantment_keystone_str}You are less slowed down using Arcane Conduit. Scales with leadership", "ImperialEnchantment", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
            ...
            _collegeOrdersKeystone.Initialize(CareerID, "{=college_orders_keystone_str}Arcane Conduit also refreshes Winds of Companions.", "CollegeOrders", false, ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
            {
                new CareerChoiceObject.MutationObject()
                {
                    MutationTargetType = typeof(AbilityTemplate),
            ...
            _magicCombatTrainingKeystone.Initialize(CareerID, "{=magic_combat_keystone_str}Your spell damage is increased for 30% during Arcane Conduit.", "MagicCombatTraining", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new CareerChoiceObject.MutationObject()
                    {
            ...
            _ancientScrollsKeystone.Initialize(CareerID, "{=ancient_scrolls_keystone_str}Cooldown reduction by 50%. Additional Usage", "AncientScrolls", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new()
                    {
            ...
            _arcaneKnowledgeKeystone.Initialize(CareerID, "{=arcane_knowledge_keystone_str}Arcane Conduit resets cooldowns of spells. Halves duration and doubles gain. Additional usage", "ArcaneKnowledge", false,
                ChoiceType.Keystone, new List<CareerChoiceObject.MutationObject>()
                {
                    new()
                    {
        ...
        {
            _studyAndPractisePassive1.Initialize(CareerID, "{=study_and_practise_passive1_str}Increases max Winds of Magic by 5.", "StudyAndPractise", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.WindsOfMagic));
            _studyAndPractisePassive2.Initialize(CareerID,
                "{=study_and_practise_passive2_str}10% Ward save if your armor weight does not exceed 11 weight.", "StudyAndPractise", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.All, 10), AttackTypeMask.All,
                    (attacker, victim, attackmask) => victim == Agent.Main && CareerChoicesHelper.ArmorWeightCheck(victim, 11) ));
            _studyAndPractisePassive3.Initialize(CareerID, "{=study_and_practise_passive3_str}Increases magic spell damage by 10%.", "StudyAndPractise", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Magical, 10), AttackTypeMask.Spell));
            _studyAndPractisePassive4.Initialize(CareerID, "{=study_and_practise_passive4_str}Increases Magic resistance against spells by 25%.", "StudyAndPractise", false, ChoiceType.Passive, null,new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.Magical,25),AttackTypeMask.Spell));
            
            _teclisTeachingsPassive1.Initialize(CareerID, "{=teclis_teachings_passive1_str}Increases fire spell damage by 10%.", "TeclisTeachings", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Fire, 10), AttackTypeMask.Spell));
            _teclisTeachingsPassive2.Initialize(CareerID, "{=teclis_teachings_passive2_str}Increases electric spell damage by 10%.", "TeclisTeachings", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Damage, new DamageProportionTuple(DamageType.Fire, 10), AttackTypeMask.Spell));
            _teclisTeachingsPassive3.Initialize(CareerID, "{=teclis_teachings_passive3_str}Increases max Winds of Magic by 5.", "TeclisTeachings", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.WindsOfMagic));
            _teclisTeachingsPassive4.Initialize(CareerID, "{=teclis_teachings_passive4_str}Powerstones cost 35% less Prestige", "TeclisTeachings", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special));
            
            _imperialEnchantmentPassive1.Initialize(CareerID, "{=imperial_enchantment_passive1_str}Increases max Winds of Magic by 5.", "ImperialEnchantment", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.WindsOfMagic));
            _imperialEnchantmentPassive2.Initialize(CareerID, "{=imperial_enchantment_passive2_str}Friendly fire damage is reduced by 30%", "ImperialEnchantment", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-30, PassiveEffectType.Special,true));
            _imperialEnchantmentPassive3.Initialize(CareerID, "{=imperial_enchantment_passive3_str}Buffs and healing duration is increased by 50%.", "ImperialEnchantment", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(50, PassiveEffectType.BuffDuration,true));
            _imperialEnchantmentPassive4.Initialize(CareerID, "{=imperial_enchantment_passive4_str}Power stones reserve 25% less Winds.", "ImperialEnchantment", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special, true));
            
            _collegeOrdersPassive1.Initialize(CareerID, "{=college_orders_passive1_str}Companion limit of party is increased by 5.", "CollegeOrders", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.CompanionLimit));
            _collegeOrdersPassive2.Initialize(CareerID, "{=college_orders_passive2_str}Magister Companions have 25 more Winds of Magic.", "CollegeOrders", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(25, PassiveEffectType.Special));
            _collegeOrdersPassive3.Initialize(CareerID, "{=college_orders_passive3_str}For every type of  College Wizard gain 10% more Prestige from combat", "CollegeOrders", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special));
            _collegeOrdersPassive4.Initialize(CareerID, "{=college_orders_passive4_str}Gain access to Power stones of other College Orders", "CollegeOrders", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special));
            
            _magicCombatTrainingPassive1.Initialize(CareerID, "{=magic_combat_training_passive1_str}Increases max Winds of Magic by 5.", "MagicCombatTraining", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.WindsOfMagic));
            _magicCombatTrainingPassive2.Initialize(CareerID, "{=magic_combat_training_passive2_str}25% spell cooldown reduction.", "MagicCombatTraining", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(-25, PassiveEffectType.WindsCooldownReduction, true)); 
            _magicCombatTrainingPassive3.Initialize(CareerID, "{=magic_combat_training_passive3_str}Increases Spell effectiveness by 15% if you wield an offhand staff.", "MagicCombatTraining", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(15, PassiveEffectType.SpellEffectiveness, true,
                (CharacterObject character) => HasMagicStaff()));
            _magicCombatTrainingPassive4.Initialize(CareerID, "{=magic_combat_training_passive4_str}Extra 20% Wardsave if your armor weight does not exceed 11 weight.", "MagicCombatTraining", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(PassiveEffectType.Resistance, new DamageProportionTuple(DamageType.All, 20), AttackTypeMask.All,
                (attacker, victim, attackmask) => victim.IsHero && victim.IsMainAgent&&  CareerChoicesHelper.ArmorWeightCheck(victim, 11) ));
            
            _ancientScrollsPassive1.Initialize(CareerID, "{=ancient_scrolls_passive1_str}Increase hex durations by 50%.", "AncientScrolls", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(50f, PassiveEffectType.DebuffDuration,true));
            _ancientScrollsPassive2.Initialize(CareerID, "{=ancient_scrolls_passive2_str}Increases Windsregeneration by 1.", "AncientScrolls", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1, PassiveEffectType.WindsRegeneration));
            _ancientScrollsPassive3.Initialize(CareerID, "{=ancient_scrolls_passive3_str}Recover 80% used Prestige from used Powerstones", "AncientScrolls", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special));
            _ancientScrollsPassive4.Initialize(CareerID, "{=ancient_scrolls_passive4_str}For every varying imperial wizard, reduce the powerstone winds upkeep by 5%.", "AncientScrolls", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.Special, true));

            
            _arcaneKnowledgePassive1.Initialize(CareerID, "{=arcane_knowledge_passive1_str}Spelldamage of companions is increased by 20%", "ArcaneKnowledge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(0, PassiveEffectType.Special));
            _arcaneKnowledgePassive2.Initialize(CareerID, "{=arcane_knowledge_passive2_str}Spell effect radius is increased by 20%.", "ArcaneKnowledge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20f, PassiveEffectType.SpellRadius,true));
            _arcaneKnowledgePassive3.Initialize(CareerID, "{=arcane_knowledge_passive3_str}Increases Spell effectiveness by 20% if your armor weight undershoots 11 stones.", "ArcaneKnowledge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(20, PassiveEffectType.SpellEffectiveness, true,
            ...
            _arcaneKnowledgePassive4.Initialize(CareerID, "{=arcane_knowledge_passive4_str}For every imperial Magister in your party, your maximum winds increases by 4", "ArcaneKnowledge", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(4, PassiveEffectType.Special,true));
        }
