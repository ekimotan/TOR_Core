...
namespace TOR_Core.CharacterDevelopment.CareerSystem.Choices
{
    public class WitchHunterCareerChoices : TORCareerChoicesBase
    {
        ...
        protected override void InitializePassives()
        {
            ...
            _huntTheWickedPassive1.Initialize(CareerID, "{=hunt_the_wicked_passive1_str}Increases health regeneration after battles by 3.", "HuntTheWicked", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(5, PassiveEffectType.HealthRegeneration));
            ...
            _swiftProcedurePassive3.Initialize(CareerID, "{=swift_procedure_passive3_str}Party movement speed is increased by 1.5.", "SwiftProcedure", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(1.5f, PassiveEffectType.PartyMovementSpeed,false));  
            ...
            _guiltyByAssociationPassive1.Initialize(CareerID, "{=guilty_by_association_passive1_str}Increases troop regeneration by 2.", "GuiltyByAssociation", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(2, PassiveEffectType.TroopRegeneration)); //TORAgentApplyDamage 29
            ...
            _guiltyByAssociationPassive3.Initialize(CareerID, "{=guilty_by_association_passive3_str}Companions have 50 additional health points.", "GuiltyByAssociation", false, ChoiceType.Passive, null, new CareerChoiceObject.PassiveEffect(50, PassiveEffectType.Special));
